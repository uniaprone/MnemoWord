...
import com.kite.mnemoai.vocabularybookgroup.databinding.AddVocabularyBinding;
import com.kite.mnemoai.vocabularybookgroup.databinding.ItemVocabularyCardBinding;
...
public class VocabularyCardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void binding(GroupDetail groupDetail){
            ...
            legend.setTextColor(MaterialColors.getColor(binding.statisticPieChart, android.R.attr.colorPrimary));
            ...
            binding.vocabularyCV.setOnClickListener((view) -> {
                ...
                bundle.putLong("group_id", groupDetail.getGroup().getId());
                bundle.putString("group_name", groupDetail.getGroup().getName());
